...
from helsinkiWeather import reqWeatherData, forecastWeatherData_3rd_Day, forecastWeatherData_3_days

logging.basicConfig(filename= 'log_HEL_WD_process', level = logging.DEBUG,
...
SQLCommand_forecastWeather = ("INSERT INTO WEATHER_FORECAST_HELSINKI"
